...
const stop_times_raw = await octdb.runAndReadAll(`SELECT source, service_window, stop_code, stop_lat_normalized, stop_lon_normalized, s_until_next_arrival FROM stop_times`)
